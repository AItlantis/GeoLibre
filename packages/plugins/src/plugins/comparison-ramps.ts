export type ComparisonMetric = "flow_delta" | "flow_density_product_delta" | "cmp_flow_sign" | "cmp_flow_density_quadrant";
...
const FALLBACK: Record<ComparisonMetric, CategoricalRamp | null> = {
  flow_delta: null, flow_density_product_delta: null,
  ...
  cmp_flow_density_quadrant: { kind:"categorical", categories:[{key:"more_flow_more_density",label:"More flow, more density",color:"#d73027"},{key:"more_flow_less_density",label:"More flow, less density",color:"#ffb000"},{key:"less_flow_less_density",label:"Less flow, less density",color:"#2166ac"},{key:"less_flow_more_density",label:"Less flow, more density",color:"#6a3d9a"},{key:"unknown",label:"Unknown",color:"#888888"}], unit:"", label:"Flow-density quadrant" },
};
